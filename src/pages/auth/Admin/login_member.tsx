...
import {loginMember} from "@/services/Admin_Service/Auth_service/login_customer_service"; // adjust path as needed
...
const Member_login: React.FC = () => {
  ...
  // Light mode colors only (same as admin)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate("/customer_dashboard"); // adjust route as needed
    } catch (error: any) {
      toast({
        title: "Error",
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-700">
                Access your member dashboard and climate insights
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link
                    to="/member-forgot-password" // adjust route as needed
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 text-center">
              <p className="text-gray-600">
                Not registered yet?{" "}
                <Link
                  to="/member_register" // adjust route as needed
